...
//   // dayMeals structure: { "Breakfast": { "Diner": ["food-id-1", ...], ... }, ... }
...
//         // Find the food details from allFoods
...
// // Function filtering menu items (unchanged)
...
//         // For now, use the first cycle. Later this can come from an endpoint
//         if (cyclesData.length > 0) {
//           setCycle(cyclesData[0]);
//         } else {
//           throw new Error('No cycles available');
//         }
...
//     const dayData = cycle.days[selectedDayIndex];
...
//         {/* Day Selector - Temporarily for testing
//         <div style={{
//           maxWidth: '600px',
//           margin: '0 auto 30px',
//           display: 'flex',
...
//               style={{
//                 padding: '10px 15px',
//                 backgroundColor: selectedDayIndex === index ? '#16a34a' : '#e5e5e5',
//                 color: selectedDayIndex === index ? 'white' : '#333',
//                 border: 'none',
//                 borderRadius: '20px',
//                 cursor: 'pointer',
//                 fontWeight: selectedDayIndex === index ? '600' : '500',
...
//           fontWeight: '600'
//         }}>
//           Menu for {days[selectedDayIndex]}
//         </div> */}
